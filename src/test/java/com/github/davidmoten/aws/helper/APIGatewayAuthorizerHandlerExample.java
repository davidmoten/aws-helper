...
import com.github.davidmoten.aws.helper.auth.AuthPolicy;
import com.github.davidmoten.aws.helper.auth.TokenAuthorizerContext;
 ...
 *
 */
public class APIGatewayAuthorizerHandlerExample implements RequestHandler<TokenAuthorizerContext, AuthPolicy> {
    ...
    public AuthPolicy handleRequest(TokenAuthorizerContext input, Context context) {
    	...
    	log.log("authorizationToken=" + token);
